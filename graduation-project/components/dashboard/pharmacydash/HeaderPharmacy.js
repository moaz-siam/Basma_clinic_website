...
export default function HeaderPharmacy({ logohandle, setIsOpen, isOpen }) {
      ...
      >
        <div className={`flex items-center justify-between gap-[34px]`}>
          <button
            ...
            className={`text-2xl block mb-4 self-end cursor-pointer ${
              logohandle ? "md:hidden block" : "visible md:invisible"
            }`}
          >
            ☰
          </button>
          ...
          <div className="flex items-center gap-[24px]">
            ...
            <button
              ...
              className={`w-[45px] h-[45px] bg-white shadow-[0px_4px_25px_0px_#A1A1A11A] rounded-full flex justify-center items-center text-center mx-auto cursor-pointer ${
