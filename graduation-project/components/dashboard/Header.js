...
import { ProfileMenu } from "@/assets";
...
export default function HeaderPatinet({ logohandle, isOpen, setIsOpen }) {
      ...
      >
        <div className="flex items-center justify-between gap-[34px]">
          <button
            ...
            className={`text-2xl block mb-4 self-end cursor-pointer md:hidden block`}
          >
            ☰
          </button>
          {logohandle && (
          ...
          <div className="w-full md:flex hidden items-center rounded-[8px] bg-white shadow-[0px_4px_25px_0px_#A1A1A11A] px-[20px] py-[14px]">
          ...
          <div className="flex items-center gap-[24px]">
            ...
            <button
              ...
              className={`w-[45px] h-[45px] overflow-hidden bg-white shadow-[0px_4px_25px_0px_#A1A1A11A] rounded-full flex justify-center items-center text-center mx-auto cursor-pointer ${
          ...
          {profilemenu && (
            <div className=" bg-white w-[300px] shadow-[0px_4px_25px_0px_#A1A1A11A] rounded-[16px] absolute left-0 top-15">
              ...
              <div className="p-[16px]">
                {ProfileMenu.map((ele) => (
                  <Link
                    onClick={() => ele?.id === 11 && handlelogout()}
                    href={ele.path}
